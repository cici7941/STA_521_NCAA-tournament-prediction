...
index=which(coef!=0)
datanewS.1=cbind(datanewS[,index], datanewS[,30])
datanewS.1=datanewS.1[,-20]
colnames(datanewS.1)[19]="result"
lm2=glmnet(datanewS.1[,1:18], datanewS.1[,19], family = "binomial", standardize = FALSE)
summary(lm2)
pred=datanewS.1[,1:18]

prediction=predict(lm2, pred, type="response" )
